import { HandCoins, Landmark, PiggyBank, SquarePen, Trash2, Wallet } from "lucide-react";
import SeparatorDemo from "./separator-demo";

export default function TransactionListDemo() {
    const data = [
        { date: '2025-03-15', type: 'Expense', description: 'cafe', category: 'Food', amount: '$5.00' },
        { date: '2025-03-13', type: 'Expense', description: 'Restaurant', category: 'Food', amount: '$30.00' },
        { date: '2025-03-5', type: 'Expense', description: 'Clothes', category: 'Clothes', amount: '$5.00' },
        { date: '2025-03-5', type: 'Expense', description: 'Phone bill', category: 'Phone', amount: '$20.00' },
        { date: '2025-02-27', type: 'Income', description: 'Monthly salary', category: '', amount: '$2,500.00' },
    ];
